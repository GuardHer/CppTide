	...
	namespace ship
	{
		...
		public:
			struct Cols
			{
				...
				static const std::string _video;
			 ...
			 */
			explicit BtnState(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

			/**
			 * @brief constructor
			 * @param pJson The json object to construct a new instance.
			 */
			explicit BtnState(const Json::Value &pJson) noexcept(false);
			 ...
			 */
			BtnState(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
			...
			/**  For column video  */
			/// Get the value of the column video, returns the default value if the column is null
			const int32_t &getValueOfVideo() const noexcept;
			/// Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
			const std::shared_ptr<int32_t> &getVideo() const noexcept;
			/// Set the value of the column video
			void setVideo(const int32_t &pVideo) noexcept;
			void setVideoToNull() noexcept;
		...
		private:
			friend drogon::orm::Mapper<BtnState>;
			friend drogon::orm::BaseBuilder<BtnState, true, true>;
			friend drogon::orm::BaseBuilder<BtnState, true, false>;
			friend drogon::orm::BaseBuilder<BtnState, false, true>;
			friend drogon::orm::BaseBuilder<BtnState, false, false>;
#ifdef __cpp_impl_coroutine
			friend drogon::orm::CoroMapper<BtnState>;
#endif
