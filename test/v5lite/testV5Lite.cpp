...
int main()
{
    Net_config yolo_nets = { 0.5, 0.6, 0.5, "E:\\Code\\CppTide\\weights\\v5lite-s.onnx", "E:\\Code\\CppTide\\test\\v5lite\\class.names" };
    YOLO yolo_model(yolo_nets);
    // string imgpath = "E:\\Code\\CppTide\\test\\v5lite\\images\\bus.jpg";
